...
score_pid5 <- function(df, item_prefix="PID_", max_impute=0.2, drop_items=FALSE,
                       bad_items=NULL, min_value=0, max_value=3, add_alphas=TRUE) {
  ...
  #compute alphas
  if (add_alphas) {
    attr(df$PID_anh,"alpha") <- psych::alpha(df[,anh_items])
    attr(df$PID_anx,"alpha") <- psych::alpha(df[,anx_items])
    attr(df$PID_attn,"alpha") <- psych::alpha(df[,attn_items])
    attr(df$PID_callous,"alpha") <- psych::alpha(df[,callous_items])
    attr(df$PID_deceit,"alpha") <- psych::alpha(df[,deceit_items])
    attr(df$PID_depres,"alpha") <- psych::alpha(df[,depres_items])
    attr(df$PID_distr,"alpha") <- psych::alpha(df[,distr_items])
    attr(df$PID_ecc,"alpha") <- psych::alpha(df[,ecc_items])
    attr(df$PID_emo_lab,"alpha") <- psych::alpha(df[,emo_lab_items])
    attr(df$PID_grnd,"alpha") <- psych::alpha(df[,grnd_items])
    attr(df$PID_host,"alpha") <- psych::alpha(df[,host_items])
    attr(df$PID_impuls,"alpha") <- psych::alpha(df[,impuls_items])
    attr(df$PID_int_avd,"alpha") <- psych::alpha(df[,int_avd_items])
    attr(df$PID_irr,"alpha") <- psych::alpha(df[,irr_items])
    attr(df$PID_man,"alpha") <- psych::alpha(df[,man_items])
    attr(df$PID_perc_dysreg,"alpha") <- psych::alpha(df[,perc_dysreg_items])
    attr(df$PID_persev,"alpha") <- psych::alpha(df[,persev_items])
    attr(df$PID_rest_aff,"alpha") <- psych::alpha(df[,rest_aff_items])
    attr(df$PID_perf,"alpha") <- psych::alpha(df[,perf_items])
    attr(df$PID_rt,"alpha") <- psych::alpha(df[,rt_items])
    attr(df$PID_sep_insec,"alpha") <- psych::alpha(df[,sep_insec_items])
    attr(df$PID_sub,"alpha") <- psych::alpha(df[,sub_items])
    attr(df$PID_sus,"alpha") <- psych::alpha(df[,sus_items])
    attr(df$PID_unusual,"alpha") <- psych::alpha(df[,unusual_items])
    attr(df$PID_wthdrwl,"alpha") <- psych::alpha(df[,wthdrwl_items])
    attr(df$PID_neg_aff,"alpha") <- psych::alpha(df[,neg_aff_items])
    attr(df$PID_detach,"alpha") <- psych::alpha(df[,detach_items])
    attr(df$PID_antag,"alpha") <- psych::alpha(df[,antag_items])
    attr(df$PID_disinhib,"alpha") <- psych::alpha(df[,disinhib_items])
    attr(df$PID_psycho,"alpha") <- psych::alpha(df[,psycho_items])
  }
